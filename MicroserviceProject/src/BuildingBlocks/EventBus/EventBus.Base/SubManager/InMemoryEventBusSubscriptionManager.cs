...
namespace EventBus.Base.SubManager
{
    public class InMemoryEventBusSubscriptionManager : IEventBusSubscriptionManager
    {
        ...
        private void AddSubScription(Type handlerType, string eventName)
        {
            ...
            if (_handlers[eventName].Any(t=> t.HandlerType == handlerType))
            {
                throw new ArgumentException($"Handler Type {handlerType.Name} already regitered for '{eventName}'", nameof(handlerType));
            }
        ...
        public Type GetEventTypeName(string eventName) => _eventTypes.SingleOrDefault(t => t.Name == eventName);
        ...
        public void RemoveHandler(string eventName, SubscriptionInfo subscriptionInfo)
        {
